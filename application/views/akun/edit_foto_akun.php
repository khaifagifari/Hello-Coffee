		...
		<div class="row mt-3 pb-3 col card text-dark">
			<div class="file-upload text-center pt-5">
				<div class="card mb-3 mx-auto" style="width : 25em; box-shadow: 0 0.5rem 1rem 0 rgba(0, 0, 0, 0.1);">
					<img class="card-img-top mx-auto" style="border-radius: 50%; object-fit: cover; width:230px; height: 230px;"src="<?php echo site_url('assets/img/'.$user[0]['Foto']) ?>" alt="Card image cap">
				</div>
				<?php echo $error;?>
				<?php echo form_open_multipart('akun/editFoto/'.$_SESSION['id_user']);?>
			    ...
			    <a href="<?php echo base_url('akun/pengaturanAkun/'); echo $_SESSION['id_user'];?>" class="btn btn-danger float-right mr-3">Kembali</a>
			</div>
		</div>
	</div>
</section>