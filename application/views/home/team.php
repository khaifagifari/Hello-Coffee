    ...
    <ul class="row">
      <li class="col-12 col-md-6 col-lg-4">
        <div class="cnt-block equal-hight" style="height: 349px;">
          <figure><img src="<?php echo base_url("assets/foto.jpg") ?>" class="img-responsive" alt=""></figure>
          <h3><a href="#">Adam Syahputra</a></h3>
          <p>Freelance Web Developer</p>
          <ul class="follow-us clearfix">
            <li><a href="https://www.facebook.com/adamhsbbb"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
            <li><a href="https://twitter.com/adamhsbbb"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
            <li><a href="https://www.instagram.com/adamhsbbb/"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
          </ul>
        </div>
      </li>
      <li class="col-12 col-md-6 col-lg-4">
