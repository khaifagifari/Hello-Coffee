			...
			<div class="col-sm-9 col-md-7 col-lg-5 mx-auto bg-transparent">
				<div class="card card-signin my-5 bg-transparent">
					<div class="card-body bg-transparent">
						...
						<form class="form-signin" method="POST" action="<?php base_url(); ?>Timeline">
							...
							<div class="row"> 
								<label class="label mr-5 ml-4 font-weight-bold">Gender :</label>
								...
								<div class="custom-control custom-radio custom-control-inline">
									<input type="radio" class="custom-control-input" id="customRadio2" name="example" value="customEx" required="">
							...
							<a class="btn btn-lg btn-secondary btn-block text-uppercase" href="<?= base_url(); ?>home" type="submit" name="login">Sign in</a>
						</form>
					</div>
				</div>
			</div>
